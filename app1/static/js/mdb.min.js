...
dropdownSelectors.on({
                ...
                return _createClass(d, [{
                    ...
                    value: function() {
                        ...
                        "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({
                            ...
                            right: 0
                        })), this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint && this.$menu.css("transform", "translateX(0)"), this.$menu.find("input[type=text]").on("touchstart", function(t) {
    ...
    function(t) {
        var e, i = function() {
            ...
            return _createClass(e, [{
                ...
                key: "_onHTMLClick",
                value: function(e) {
                    t(e.target).closest("#select-options-".concat(this.uuid)).length || t(e.target).hasClass("mdb-select") || !t("#select-options-".concat(this.uuid)).hasClass("active") || (this.$materialSelect.trigger("close"), this.mainLabel.removeClass("active-check")), this.isSearchable && null !== this.$searchInput && this.$materialOptionsList.hasClass("active") && this.$materialOptionsList.find(".search-wrap input.search").focus()
                }
            }, {
    ...
    }(jQuery), jQuery("select").siblings("input.select-dropdown", "input.multi-bs-select").on("mousedown", function(t) {
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, I, P, A, O, _, D, E, L, $, F, R, W, V, N, z, H, j, B, Y, q, X, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Zt = {
                    ...
                    updateSize: function(e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, _t(ft.x * ht), St("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Ot((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && Ne() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Qe(s), At(s));
                            w = !1
                        }
                ...
                Me = function(t, e) {
                    var i, n, o, s, l = ut[t] + e[t],
                        ...
                        u = ce.x + e.x,
                        d = ce.x - ne.x;
                    return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || q || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && Ne() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && Ne() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (_t(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
                },
                Te = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!j || "mousedown" !== t.type) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            Z = null, Ut(), B && 1 !== n || (B = nt = !0, o.bind(window, p, a), z = rt = ot = H = Q = X = Y = q = !1, it = null, St("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }], V = W = Mt(), Rt(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, q = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                        }
                    }
                },
                Ie = function(t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                                ...
                                0 > n && (n = 0), be(Kt, Gt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Et(de, se), ut.x = Dt("x", i), ut.y = Dt("y", i), z = i > g, g = i, Pt()
                            } else {
                                if (!it) return;
                ...
                Ae = function(t) {
                    ...
                    var c = -1;
                    if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, X || q || et || H)
